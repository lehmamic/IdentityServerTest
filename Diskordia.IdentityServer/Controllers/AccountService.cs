...
namespace Diskordia.IdentityServer.Controllers
{
  public class AccountService
  {
    ...
    public async Task<LoginViewModel> BuildLoginViewModelAsync(string returnUrl)
    {
      ...
      var schemes = this.httpContextAccessor.HttpContext.Authentication.GetAuthenticationSchemes();
    ...
    public async Task<LogoutViewModel> BuildLogoutViewModelAsync(string logoutId)
    {
      ...
      var user = await this.httpContextAccessor.HttpContext.GetIdentityServerUserAsync();
